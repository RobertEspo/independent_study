...
Rao found that gender and dialect have significant differences in constitutent length, but not necessarily in phrase final position. He claims that, although he did not find significant results for phrase final length differences for gender/dialect, a more robust dataset may show significance. He also suggests a different style of speech (as opposed to reading). He finds that males read faster than females; that is, their mean duration of word, stressed syllable, and final syllable are significantly shorter.

In terms of dialect, Cubans produced the lowest values for mean duration of word, stressed syllable, and final syllable, while Spaniards produced the highest. These two groups were significantly different. Ecuadorians placed in between these two groups. They grouped together with Spaniards in mean duration of word and stressed syllable, but for mean duration of final syllable, they grouped with Ecuadorians. Rao does not provide an explanation for why this might be, and it is only implied that the values for the unmentioned comparisons are significant.
